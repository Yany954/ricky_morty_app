              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'Roboto'), // Estilo del texto de etiqueta
                    ...
                    border: OutlineInputBorder(
                      borderSide: BorderSide(color: Colors.transparent), // Color del borde del campo de entrada
                      borderRadius: BorderRadius.circular(10.0), // Radio de borde para redondear
                    ),
                    focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(color: Colors.transparent), // Color del borde cuando el campo está enfocado
                      borderRadius: BorderRadius.circular(10.0), // Radio de borde para redondear
                    ),
                  ),
                ),
